...
class Hotaltop extends Component {
    state = {
        hotalist: [
            {
                imgurl: require("../../images/aht1.jpg"),
                title: '花筑·阳朔西街忆景酒店',
                place: '阳朔',
            ...
            {
                imgurl: require("../../images/aht2.jpg"),
                title: '花筑·台儿庄古城兰邸客栈',
                place: '台儿庄古城',
            ...
            {
                imgurl: require("../../images/aht3.jpg"),
                title: '花筑·杭州漫居度假酒店',
                place: '西湖',
                rode: '虎跑路四眼井58号',
                tag: ['杭州西湖',
            ...
            {
                imgurl: require("../../images/aht4.jpg"),
                title: '花筑·昆明芙洛拉花园酒店',
                place: '昆明',
            ...
            {
                imgurl: require("../../images/aht5.jpg"),
                title: '花筑·重庆解放碑美拉酒店',
                place: '重庆',
                rode: '八一路238号八一广场八楼',
                tag: ['重庆市中心',
            ...
            {
                imgurl: require("../../images/aht6.jpg"),
                title: '花筑·重庆观音桥星悦荟民宿',
                place: '重庆',
            ...
            {
                imgurl: require("../../images/aht7.jpg"),
            ...
            {
                imgurl: require("../../images/aht8.jpg"),
            ...
            {
                imgurl: require("../../images/aht9.jpg"),
                title: '花筑·杭州越上云舍精品民宿',
                place: '西湖',
                rode: '三台山路三台云舍69号',
                tag: ['江南院落',
                    ...
                    <div className="swiper-container">
                        <div className="swiper-wrapper">
                            ...
                            {/* <div className="swiper-slide">
                                <div className="imgbox">
                                    <img src={require("../../images/aht1.jpg")} />
                                </div>
                            </div>
                            <div className="swiper-slide">
                                <div className="imgbox">
